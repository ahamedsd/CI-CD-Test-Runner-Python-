...
This tool is helpful for anyone learning testing, continuous integration, or basic DevOps concepts. It is especially useful for beginners who want hands-on experience with automation but do not want to deal with heavy tools or complicated setups.

How To Run
To use the tool, simply run the test_runner.py file inside the src folder. The tests will run automatically, and the HTML report will be generated inside the reports folder.
...
Summary
TestPilot CI Runner gives you a lightweight, easy-to-understand testing workflow. It helps you automate your tests, generate readable reports, and keep track of what is happening inside your project. It’s simple enough for beginners but flexible enough to evolve into a more serious automation tool.